      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-16 items-center mb-20 md:mb-32">
          <div className="relative">
            {/* Pulsing background element - adapts to dark mode */}
          ...
          <div className="grid grid-cols-2 gap-3 md:gap-4">
            {stats.map((stat, idx) => (
              <div key={idx} className="p-5 md:p-8 bg-slate-50 dark:bg-slate-900 rounded-2xl md:rounded-3xl border border-slate-100 dark:border-slate-800 hover:border-blue-200 dark:hover:border-blue-700 hover:bg-white dark:hover:bg-slate-800 hover:shadow-xl transition-all duration-500 group">
                <div className="text-2xl md:text-4xl font-black text-blue-900 dark:text-blue-400 mb-1 group-hover:scale-110 transition-transform origin-left">
                  {stat.value}
                </div>
        ...
        {/* 2. MISSION/VISION/VALUES BOX - Darkened even more for Dark Mode contrast */}
        <div className="bg-blue-950 dark:bg-slate-900 rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 lg:p-20 text-white relative shadow-2xl mb-20 md:mb-32 border border-transparent dark:border-slate-800">
          ...
          <div className="min-h-[200px] md:min-h-[300px]">
            {aboutTab === "mission" && (
              <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <p className="text-lg md:text-xl text-slate-300 dark:text-slate-400 leading-relaxed max-w-3xl">
        ...
        <div className="mb-20 md:mb-32">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-8">
            {[
              ...
              <div key={i} className="group p-6 md:p-8 bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-2xl md:rounded-3xl shadow-sm hover:shadow-xl dark:hover:shadow-blue-900/10 transition-all duration-300">
                <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center font-black mb-6 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white transition-colors">
                  {i + 1}
                </div>
          ...
          <div className="space-y-20 md:space-y-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-center">
              ...
              <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
                <div className="w-full max-w-xs md:max-w-md bg-white dark:bg-slate-800 p-2 md:p-3 rounded-2xl border border-slate-100 dark:border-slate-700 shadow-xl">
                  ...
                  {certs.isoIcons.map((icon, i) => {
                    ...
                    return (
                      <div key={i} className="flex items-center gap-4 group">
                        <div className="bg-white dark:bg-slate-200 p-1 rounded-md">
